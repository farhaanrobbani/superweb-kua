<section x-data="jadwalSholat()" x-init="init()" class="mx-auto max-w-5xl px-6 py-10">
    <div class="rounded-lg border border-teal-100 bg-white shadow-sm">
        <div class="flex items-center gap-2 border-b border-teal-100 bg-teal-50/60 px-5 py-3">
            <p class="text-xs font-semibold uppercase tracking-wide text-teal-800">Jadwal Sholat</p>
            <span class="rounded-full bg-teal-700 px-2 py-0.5 text-xs font-semibold text-white">Ampelgading</span>
        ...
        <div class="px-5 py-4">
            ...
            <div x-show="!loading && timings" class="grid grid-cols-5 gap-3">
                <template x-for="item in displayTimings" :key="item.key">
                    <div class="rounded-lg border p-3 text-center"
                        ...
                        <p class="mt-1 text-sm font-bold text-teal-900 sm:text-base" x-text="item.time"></p>
