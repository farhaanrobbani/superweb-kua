<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Tambah Topik Keagamaan</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('religious-services.store') }}" class="space-y-6">
                @csrf
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <x-text-input id="name" name="name" required maxlength="150"
                                          ...
                                          placeholder="contoh: Pembinaan Majelis Taklim" />
