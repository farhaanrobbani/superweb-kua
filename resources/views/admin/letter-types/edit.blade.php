                ...
                <form method="POST" action="{{ route('letter-types.update', $letterType) }}"
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="description" name="description" rows="2"
                                  class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $letterType->description) }}</textarea>
