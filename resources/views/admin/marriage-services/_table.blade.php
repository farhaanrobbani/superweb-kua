    ...
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead class="bg-gray-50 dark:bg-gray-700/40">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase">Alur Permohonan</th>
            ...
            @forelse ($marriageServices as $item)
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm space-x-2">
                        <a href="{{ route('marriage-services.edit', $item) }}" class="text-blue-600 dark:text-blue-400 hover:underline">Edit</a>
