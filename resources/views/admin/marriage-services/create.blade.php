                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <x-text-input id="target_url" name="target_url" maxlength="255"
                                              value="{{ old('target_url') }}" class="mt-1 block w-full"
                                              placeholder="/permohonan?jenis=SPD" />
                            ...
                            <div>
                                ...
                                <select name="icon" id="icon"
                                    ...
                                    @foreach (\App\Http\Controllers\Admin\MarriageServiceController::ICONS as $key => $label)
                                        <option value="{{ $key }}" @selected(old('icon', 'heart') === $key)>{{ $label }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="persyaratan" name="persyaratan" rows="7" maxlength="5000"
                                      class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm text-sm font-mono">{{ old('persyaratan') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="alur" name="alur" rows="7" maxlength="5000"
                                      class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm text-sm font-mono">{{ old('alur') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="sop" name="sop" rows="6" maxlength="5000"
                                      class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm text-sm font-mono">{{ old('sop') }}</textarea>
