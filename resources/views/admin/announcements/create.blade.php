                        ...
                        <div class="px-4 py-4 space-y-4">
                            <div>
                                ...
                                <select name="category" id="category"
                                    ...
                                    @foreach ($categories as $item)
                                        <option value="{{ $item->value }}" @selected((string) old('category', 'announcement') === $item->value)>{{ $item->label() }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="excerpt" id="excerpt" rows="3" maxlength="500"
                                          class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm text-sm"
                                          placeholder="otomatis dari isi konten">{{ old('excerpt') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
