        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('announcements.store') }}" enctype="multipart/form-data" class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-lg shadow-sm">
                        ...
                        <div class="px-4 py-4 space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Kosongkan untuk langsung terbit hari ini.</p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm" x-data="{ preview: null, selected: false }">
                        <div class="border-b border-gray-100 px-4 py-3">
                            <h3 class="text-sm font-semibold text-gray-700">Gambar Sampul</h3>
                        </div>
                        <div class="px-4 py-4">
                            <label for="image" class="cursor-pointer block text-center text-sm text-gray-600">
                            ...
                            <img x-show="preview" :src="preview" alt="Pratinjau sampul"
                                 class="mt-3 w-full rounded-md border border-gray-200 object-contain" />
