                ...
                <form method="POST" action="{{ route('announcements.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="content" name="content" data-editor rows="12"
                                  class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm">{{ old('content') }}</textarea>
                        <x-input-error :messages="$errors->get('content')" class="mt-2" />
                    </div>

                    <div class="mt-4" x-data="{ preview: null, selected: false }">
                        ...
                        <img x-show="preview" :src="preview" class="mt-3 max-h-48 rounded-md border border-gray-200 object-contain" />
