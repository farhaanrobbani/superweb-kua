<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Tambah Video</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('videos.store') }}" enctype="multipart/form-data" class="grid gap-6 lg:grid-cols-3">
                @csrf
                    ...
                    <div class="bg-white rounded-lg shadow-sm dark:bg-gray-800">
                        ...
                        <div class="px-4 py-4 space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">YouTube atau kemenag.go.id/videos; hanya tautan yang disimpan.</p>
                    ...
                    <div class="bg-white rounded-lg shadow-sm dark:bg-gray-800">
                        ...
                        <div class="px-4 py-4">
                            <textarea name="excerpt" id="excerpt" rows="3" maxlength="500"
                                      class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm text-sm"
                                      placeholder="otomatis dari deskripsi">{{ old('excerpt') }}</textarea>
                        </div>
                    </div>
                </div>
            </form>
