<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Download Center</h2>
    </x-slot>
            ...
            <div class="bg-white overflow-x-auto shadow-sm sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($downloadItems as $item)
                            <tr>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    ...
                                    @if ($item->description)
                                        <p class="text-xs text-gray-500 mt-0.5">{{ str($item->description)->limit(80) }}</p>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">
                                    ...
                                    @else
                                        <span class="text-xs text-blue-600">Link eksternal</span>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm space-x-2">
                                    <a href="{{ route('download-items.edit', $item) }}" class="text-blue-600 hover:underline">Edit</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-sm text-gray-500">Belum ada berkas.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
