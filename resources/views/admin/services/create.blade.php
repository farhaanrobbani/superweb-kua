                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <x-text-input id="name" name="name" required maxlength="150"
                                          ...
                                          placeholder="contoh: Pengajuan Surat Online" />
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Konten page ini tampil di halaman publik <code>/layanan/slug</code>. Layanan dengan konten otomatis ditautkan ke halaman ini di navbar &amp; beranda.</p>
