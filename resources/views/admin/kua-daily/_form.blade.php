<div class="bg-white rounded-lg shadow-sm">
    <div class="border-b border-gray-100 px-6 py-4">
        <h3 class="text-sm font-semibold text-gray-700">Volume Layanan Harian</h3>
        <p class="text-xs text-gray-500 mt-0.5">Isi 0 untuk jenis layanan yang tidak berjalan pada tanggal tersebut.</p>
    </div>
    <div class="px-6 py-4 space-y-4">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">Jika tanggal sudah ada, data akan diperbarui.</p>
        </div>
        ...
        <div class="pt-2 border-t border-gray-100 flex items-center gap-3">
            ...
            <a href="{{ route('kua-daily.index') }}" class="text-sm text-gray-600 hover:underline">Batal</a>
        </div>
    </div>
</div>
