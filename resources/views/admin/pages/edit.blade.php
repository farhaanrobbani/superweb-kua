<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('pages.update', $page) }}" enctype="multipart/form-data" class="grid gap-6 lg:grid-cols-3">
                @csrf
                @method('PUT')
                    ...
                    <div class="bg-white rounded-lg shadow-sm">
                        <div class="p-6">
                            <input type="text" name="title" id="title" required maxlength="200"
                                   value="{{ old('title', $page->title) }}" placeholder="Tambahkan judul halaman"
                        ...
                        <div class="px-4 py-4 space-y-4">
                            <div>
                                ...
                                <select name="active" id="active"
                                    ...
                                    <option value="1" @selected(old('active', $page->active))>Aktif (ditampilkan)</option>
                                    <option value="0" @selected(! old('active', $page->active))>Nonaktif (draf)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" id="slug" maxlength="200"
                                       value="{{ old('slug', $page->slug) }}" placeholder="tentang-kami"
                                       class="mt-1 block w-full border-gray-300 focus:border-teal-500 focus:ring-teal-500 rounded-md shadow-sm text-sm" />
