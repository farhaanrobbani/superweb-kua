<div class="mb-4 flex justify-end">
    <a href="{{ route('wakaf-services.create') }}"
            ...
            @forelse ($wakafServices as $item)
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm space-x-2">
                        <a href="{{ route('wakaf-services.edit', $item) }}" class="text-blue-600 dark:text-blue-400 hover:underline">Edit</a>
                        <form action="{{ route('wakaf-services.destroy', $item) }}" method="POST" class="inline"
...
<div class="mt-4">{{ $wakafServices->links() }}</div>
