<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Sub Menu {{ $parent?->label }}</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('navbar.sub.update', $subItem) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  maxlength="1000">{{ old('description', $subItem->description) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Tujuan tautan sub menu, misalnya /permohonan atau tautan eksternal.</p>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="embed_url" name="embed_url" type="url" class="mt-1 block w-full" maxlength="255"
                                      value="{{ old('embed_url', $subItem->embed_url) }}"
