                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="mt-4 flex flex-wrap items-center gap-6">
                                <div>
                                    ...
                                    <select name="header_spasi" class="mt-1 rounded-md border-gray-300 text-sm">
                                        <option value="1" {{ old('header_spasi', '1.5') === '1' ? 'selected' : '' }}>1</option>
                                        <option value="1.5" {{ old('header_spasi', '1.5') === '1.5' ? 'selected' : '' }}>1,5</option>
                                    </select>
                                </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 h-fit">
                        ...
                        @if ($selectedType->templates->first())
                            <div class="text-sm text-gray-800 bg-gray-50 rounded-md p-3">{!! \App\Support\ColonTableFormatter::format(\App\Support\HtmlSanitizer::normalize($selectedType->templates->first()->body)) !!}</div>
                        @else
