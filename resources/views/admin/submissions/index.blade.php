<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Permohonan Surat</h2>
    </x-slot>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-800">
                        @forelse ($submissions as $submission)
                            <tr>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $submission->nama_pemohon }}</div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{{ $submission->kontak }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm space-x-2">
                                    <a href="{{ route('submissions.show', $submission) }}" class="text-blue-600 dark:text-blue-400 hover:underline">Detail</a>
