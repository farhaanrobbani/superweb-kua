<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Edit Pengumuman Kehendak Nikah</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg dark:bg-gray-800 p-6">
                <form method="POST" action="{{ route('marriage-announcements.update', $announcement) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <x-text-input id="no_pendaftaran" name="no_pendaftaran" class="mt-1 block w-full"
                                          ...
                                          value="{{ old('no_pendaftaran', $announcement->no_pendaftaran) }}" />
                        ...
                        <div>
                            ...
                            <x-text-input id="tanggal_akad" name="tanggal_akad" type="date" class="mt-1 block w-full" required
                                          value="{{ old('tanggal_akad', $announcement->tanggal_akad?->format('Y-m-d')) }}" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="tempat_nikah" name="tempat_nikah" class="mt-1 block w-full"
                                          ...
                                          value="{{ old('tempat_nikah', $announcement->tempat_nikah) }}" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="status_wali" name="status_wali" class="mt-1 block w-full"
                                          ...
                                          value="{{ old('status_wali', $announcement->status_wali) }}" />
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <x-text-input id="nama_pria" name="nama_pria" class="mt-1 block w-full" required
                                          ...
                                          value="{{ old('nama_pria', $announcement->nama_pria) }}" />
                        ...
                        <div>
                            ...
                            <x-text-input id="bin_pria" name="bin_pria" class="mt-1 block w-full"
                                          ...
                                          value="{{ old('bin_pria', $announcement->bin_pria) }}" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="alamat_pria" name="alamat_pria" class="mt-1 block w-full"
                                          ...
                                          value="{{ old('alamat_pria', $announcement->alamat_pria) }}" />
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <x-text-input id="nama_wanita" name="nama_wanita" class="mt-1 block w-full" required
                                          ...
                                          value="{{ old('nama_wanita', $announcement->nama_wanita) }}" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <x-text-input id="alamat_wanita" name="alamat_wanita" class="mt-1 block w-full"
                                          ...
                                          value="{{ old('alamat_wanita', $announcement->alamat_wanita) }}" />
                    ...
                    <div class="mt-6">
                        <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                            <input type="checkbox" name="active" value="1"
                                   ...
                                   {{ old('active', $announcement->active) ? 'checked' : '' }}>
